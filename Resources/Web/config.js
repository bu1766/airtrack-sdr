...
// Local RTL-SDR V4 / dump1090-fa receiver defaults.
// Kuala Lumpur is used only as the initial map viewport; no precise receiver
// position is published by the decoder.
PlaneCountInTitle = true;
MessageRateInTitle = true;
DisplayUnits = "nautical";
DefaultZoomLvl = 8;
DefaultCenterLat = 3.1390;
DefaultCenterLon = 101.6869;
MapType_tar1090 = "osm";
labelZoom = 6;
